...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExternalJob'
        db.create_table(u'jobs_externaljob', (
            ...
            ('date_expire', self.gf('django.db.models.fields.DateField')()),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('employer', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'jobs', ['ExternalJob'])


    def backwards(self, orm):
        # Deleting model 'ExternalJob'
        db.delete_table(u'jobs_externaljob')
