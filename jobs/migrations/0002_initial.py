...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'jobs_phonenumber', (
        ...
        db.send_create_signal(u'jobs', ['PhoneNumber'])
        ...
        db.create_table(u'jobs_job', (
            ...
            ('phone_number', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jobs.PhoneNumber'])),
        ...
        db.create_table(u'jobs_jobapplication', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal(u'jobs', ['JobApplication'])


    def backwards(self, orm):
        # Deleting model 'PhoneNumber'
        db.delete_table(u'jobs_phonenumber')

        # Deleting model 'Job'
        db.delete_table(u'jobs_job')

        # Deleting model 'JobApplication'
        db.delete_table(u'jobs_jobapplication')
